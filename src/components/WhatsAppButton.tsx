...
export function WhatsAppButton({ label, whatsapp }: { label: string; whatsapp?: string }) {
  ...
  return (
    <a
      ...
      aria-label={label}
      className="fixed bottom-5 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-card transition-transform hover:scale-105 ltr:right-5 rtl:left-5"
    >
